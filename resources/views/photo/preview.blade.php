...
<body class="min-h-screen flex flex-col items-center justify-center font-[DM_Sans] bg-cover bg-no-repeat bg-fixed"
    ...
    <div
        class="max-w-3xl w-full overflow-auto mx-auto bg-[#151515] border border-[#A1A1AA] flex flex-col gap-5 rounded-xl shadow-xl shadow-black/40 p-4 mt-10 text-white">
