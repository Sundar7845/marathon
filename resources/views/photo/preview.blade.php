...
<body class="min-h-screen flex flex-col items-center justify-center font-[DM_Sans] bg-cover bg-no-repeat bg-fixed" style="background-image: url('{{ asset('bg.jpg') }}')">

    <div class="max-w-3xl flex flex-col lg:flex-row w-full overflow-auto mx-auto bg-[#151515] border border-[#A1A1AA] gap-5 rounded-xl shadow-xl shadow-black/40 p-4 mt-10 text-white">
                        ...
                        <table width="100%">
                            <tr>
                                ...
                                <td width="50%" align="center">
                                        <div class="rounded-full border-2 border-amber-600 h-[300px] w-[200px] overflow-hidden">
                                        <img src="{{ asset('/storage/' . $participant->photo_path) }}" alt="Participant Photo" class="object-cover w-full h-full">
                                        </div>
                                    
                                    <div style="font-size:20px;font-weight:600;text-transform:uppercase;text-align:center;margin-top:10px;margin-bottom:20px;">
                                ...
                                <td width="50%" align="center" style="background-image: url('{{ asset('img/bg-image.png') }}');background-size: contain; background-repeat: no-repeat;background-position: center;">
                                    <p style="font-weight:600;margin-bottom:10px;font-size:16px;">SCAN QR FOR <br> REGISTRATION</p>
                                    <img src="{{ asset('img/qr_code.png') }}" alt="QR Code for Registration" width="150" style="margin-bottom:10px;">
                                    <p style="font-size:24px;font-weight:bold;color:#f58220;">I AM RUNNING</p>
                                    <p style="font-size:24px;font-weight:600;color:#f58220;">ARE YOU RUNNING?</p>
                                </td>
                            </tr>
                        </table>
                    </td>
                        ...
                        <table width="100%">
                            <tr valign="top">
                                ...
                                <td width="30%" align="center" style="padding-right:20px;">
                                    <h3 style="font-size:12px;font-weight:600;margin-bottom:10px;">IN ASSOCIATION WITH</h3>
                                    <table width="100%">
                                        <tr>
                                            <td align="center"><img src="{{ asset('img/saliwan_runners_logo.png') }}" alt="Saliwan Runners" width="80"></td>
                                            <td align="center"><img src="{{ asset('img/genesis_logo.png') }}" alt="Genesis Foundation" width="80"></td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td width="70%" style="border-left:1px solid #000;padding-left:20px;">
                                    <h3 style="font-size:12px;font-weight:600;text-align:center;margin-bottom:10px;">OUR SPONSORS</h3>
                                    <table width="100%">
                                        <tr align="center">
                                            <td><img src="{{ asset('img/gjv_logo.png') }}" alt="GJV Realtors" width="80"></td>
                                            <td><img src="{{ asset('img/kavery_logo.png') }}" alt="Kavery Premium Tank" width="80"></td>
                                            <td><img src="{{ asset('img/pranay_logo.png') }}" alt="Pranay Agencies & Infraa" width="80"></td>
                                            <td><img src="{{ asset('img/tilebros_logo.png') }}" alt="The Tile Bros" width="80"></td>
                                        </tr>
                                        <tr align="center">
                                            <td><img src="{{ asset('img/mangum_logo.png') }}" alt="Mangum Properties" width="80"></td>
                                            <td><img src="{{ asset('img/radiomirchi_logo.png') }}" alt="Radio Mirchi" width="80"></td>
                                            <td><img src="{{ asset('img/bmch_logo.png') }}" alt="BMCH" width="80"></td>
                                            <td></td>
                                        </tr>
                                    </table>
                                </td>
